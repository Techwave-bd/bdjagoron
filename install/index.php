...
// Always redirect to step2 unless already on a step
if (!isset($_GET['step2']) && !isset($_GET['step3']) && !isset($_GET['step4']) && !isset($_GET['complete']) && !isset($_GET['launchapp'])) {
...
if (isset($_GET['launchapp']) && $Validation->checkEnvFileExists() === false) {
    // No Verification check! Directly proceed for dev/local
    $launch = true; // Always allow launch
                        ...
                        <div id="wizard" class="aiia-wizard">
                            ...
                            <div class="aiia-wizard-step <?php echo (isset($_GET['step2']) ? 'active' : '') ?>">
                                ...
                                <div class="row action_btns">
                                    <!-- No Previous button since Step 1 is removed -->
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="row action_btns">
                                            ...
                                            <button type="submit" class='btn btn-success pull-right logininfo'>Next</button> 
                                        </div>
                                    </form>
                            </div>
                            <div class="aiia-wizard-step <?php echo (isset($_GET['complete'])?'active':'') ?>">
                                ...
                                <div class="step-content step-five">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="text-center" id="btn-complete">
